...
This feature is only available in Marathon deployed with DC/OS. See [the DC/OS docs](https://docs.mesosphere.com/1.11/security/ent/iam-api/) for this feature.
