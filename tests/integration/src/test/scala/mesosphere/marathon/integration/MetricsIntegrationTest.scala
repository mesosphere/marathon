...
class MetricsIntegrationTest extends AkkaIntegrationTest with EmbeddedMarathonTest {
  ...
  "Marathon metrics" should {
    "have metrics" in {
      ...
      gauges should contain("marathon.instances.overdue.gauge")
      gauges should contain("marathon.instances.doomed.gauge")
      gauges should contain("marathon.instances.doomed.kill-attempts.gauge")
