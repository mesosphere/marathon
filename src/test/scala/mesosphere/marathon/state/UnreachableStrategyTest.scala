...
class UnreachableStrategyTest extends UnitTest with ResultMatchers {
  ...
  "UnreachableStrategy.unreachableStrategyValidator" should {
    ...
    "fail with invalid time until inactive" in {
      ...
      UnreachableStrategy.unreachableStrategyValidator(strategy) should failWith("unreachableInactiveAfter" -> "got 0 seconds, expected 1 second or more")
    }
    ...
    "fail when time until expunge is smaller" in {
      ...
      UnreachableStrategy.unreachableStrategyValidator(strategy) should failWith("unreachableInactiveAfter" -> "got 2 seconds, expected less than 1 second")
    }
    ...
    "fail when time until expunge is equal to time until inactive" in {
      ...
      UnreachableStrategy.unreachableStrategyValidator(strategy) should failWith("unreachableInactiveAfter" -> "got 2 seconds, expected less than 2 seconds")
    }
  }
}
