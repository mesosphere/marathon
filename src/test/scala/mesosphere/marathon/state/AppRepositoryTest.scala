...
class AppRepositoryTest extends MarathonSpec {
  ...
  test("App") {
    ...
    val appDef = AppDefinition(id = path, versionInfo = AppDefinition.VersionInfo.OnlyVersion(timestamp))
  ...
  test("Apps") {
    ...
    val appDef1Old = appDef1.copy(
      versionInfo = AppDefinition.VersionInfo.OnlyVersion(Timestamp(appDef1.version.toDateTime.minusDays(1)))
    )
    val appDef2Old = appDef2.copy(
      versionInfo = AppDefinition.VersionInfo.OnlyVersion(Timestamp(appDef2.version.toDateTime.minusDays(1)))
    )
  ...
  test("ListVersions") {
    ...
    val version2 = appDef1.copy(
      versionInfo = AppDefinition.VersionInfo.OnlyVersion(Timestamp(appDef1.version.toDateTime.minusDays(2)))
    )
    val version3 = appDef1.copy(
      versionInfo = AppDefinition.VersionInfo.OnlyVersion(Timestamp(appDef1.version.toDateTime.minusDays(3)))
    )
