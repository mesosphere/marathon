...
class RootGroupTest extends UnitTest with GroupCreation {
  "A Group" should {
    ...
    "can replace a group without apps by an app definition" in {
      ...
      validate(changed)(RootGroup.rootGroupValidator(Features.empty)) should be(Success)
    }
    ...
    "cannot replace a group with apps by an app definition" in {
      ...
      val result = validate(changed)(RootGroup.rootGroupValidator(Features.empty))
    ...
    "Group with app in wrong group is not valid" in {
      ...
      When("group is validated")
      val invalidResult = validate(invalid)(RootGroup.rootGroupValidator(Features.empty))
    ...
    "Group with app in correct group is valid" in {
      ...
      When("group is validated")
      val validResult = validate(valid)(RootGroup.rootGroupValidator(Features.empty))
