...
import mesosphere.marathon.Protos.Network
...
class NetworkTest extends MarathonSpec with Matchers {
  ...
  test("ConstructFromProto") {
    ...
    val networkInfo1 = Network.newBuilder.build
