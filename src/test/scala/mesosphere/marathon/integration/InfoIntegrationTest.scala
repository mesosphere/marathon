...
@IntegrationTest
class InfoIntegrationTest extends AkkaIntegrationFunTest with EmbeddedMarathonTest {
...
@IntegrationTest
class AuthorizedZooKeeperInfoIntegrationTest extends AkkaIntegrationFunTest with EmbeddedMarathonTest {
