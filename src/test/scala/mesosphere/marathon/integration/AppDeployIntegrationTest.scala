...
import mesosphere.marathon.core.health.{ MarathonHttpHealthCheck, MarathonTcpHealthCheck, MesosCommandHealthCheck, MesosHttpHealthCheck, MesosTcpHealthCheck }
...
class AppDeployIntegrationTest
  ...
  ignore("create a simple app with a Mesos HTTP health check") {
    Given("a new app")
