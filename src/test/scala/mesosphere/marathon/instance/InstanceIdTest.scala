...
class InstanceIdTest extends UnitTest with Inside {
  ...
  "InstanceId" should {
    ...
    "be created by static string" in {
      ...
      val uuid = UUID.fromString("b6ff5fa5-7714-11e7-a55c-5ecf1c4671f6")
      val instanceId = Instance.Id(AbsolutePathId("/app"), PrefixMarathon, uuid)
    ...
    "be reconstructed from every possible reservation id" in {
      ...
      Reservation
        .Id("app.instance-4455cb85-0c16-490d-b84e-481f8321ff0a")
        .instanceId shouldEqual podTaskIdWithContainerNameAndAttempt.instanceId
    }
  }
}
