...
class HealthCheckTest extends MarathonSpec {
  ...
  test("MergeFromProto Marathon HTTP HealthCheck with portIndex") {
  ...
  test("MergeFromProto Marathon HTTP HealthCheck with port") {
    val proto = Protos.HealthCheckDefinition.newBuilder
      .setPath("/health")
      .setProtocol(Protocol.HTTP)
      .setGracePeriodSeconds(10)
  ...
  test("MergeFromProto Marathon HTTP HealthCheck with neither port nor portIndex") {
    val proto = Protos.HealthCheckDefinition.newBuilder
      .setPath("/health")
      .setProtocol(Protocol.HTTP)
      .setGracePeriodSeconds(10)
  ...
  test("MergeFromProto Marathon TCP HealthCheck with portIndex") {
    val proto = Protos.HealthCheckDefinition.newBuilder
  ...
  test("MergeFromProto Marathon HTTPS HealthCheck") {
    val proto = Protos.HealthCheckDefinition.newBuilder
      .setPath("/health")
