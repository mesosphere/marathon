...
object Task {
  ...
  object Id {
    ...
    // Note: Marathon 1.4.0 - 1.4.2 allowed pod container names without any restriction.
    //       To match task ids generated by these versions, the container name regexp is relaxed: ".+"
    //       A validation rule is added so container names match this regexp in the future: "^[a-z0-9]([-a-z0-9]*[a-z0-9])?$"
