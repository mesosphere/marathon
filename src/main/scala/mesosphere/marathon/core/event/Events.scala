...
case class RemoveHealthCheck(appId: PathId, eventType: String = "remove_health_check_event", timestamp: String = Timestamp.now().toString)
    extends MarathonHealthCheckEvent
...
case class AppTerminatedEvent(appId: PathId, eventType: String = "app_terminated_event", timestamp: String = Timestamp.now().toString)
    extends MarathonEvent
...
case class InstanceChanged(id: Instance.Id, runSpecVersion: Timestamp, runSpecId: PathId, condition: Condition, instance: Instance)
    extends MarathonEvent {
...
case class UnknownInstanceTerminated(id: Instance.Id, runSpecId: PathId, condition: Condition) extends MarathonEvent {
  override val eventType: String = "unknown_instance_terminated_event"
  override val timestamp: String = Timestamp.now().toString
}

case class InstanceHealthChanged(id: Instance.Id, runSpecVersion: Timestamp, runSpecId: PathId, healthy: Option[Boolean])
    extends MarathonEvent {
