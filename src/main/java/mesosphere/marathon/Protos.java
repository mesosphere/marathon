...
public final class Protos {
  ...
  public interface EventSubscribersOrBuilder
    ...
    java.util.List<String> getExecCmdsList();
    int getExecCmdsCount();
    String getExecCmds(int index);
  }
  public static final class EventSubscribers extends
    ...
    public String getExecCmds(int index) {
  ...
  ensureExecCmdsIsMutable();
      ...
      public Builder addExecCmds(String value) {
        if (value == null) {
    throw new NullPointerException();
  }
  ensureExecCmdsIsMutable();
      ...
      void addExecCmds(com.google.protobuf.ByteString value) {
        ensureExecCmdsIsMutable();
        execCmds_.add(value);
        onChanged();
      }
