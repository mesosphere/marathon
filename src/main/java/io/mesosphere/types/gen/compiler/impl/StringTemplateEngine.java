package io.mesosphere.types.gen.compiler.impl;

import io.mesosphere.types.gen.compiler.internal.*;
import io.mesosphere.types.gen.compiler.internal.arguments.PrecalcValueArguments;
import io.mesosphere.types.gen.compiler.internal.arguments.TypeArguments;
import io.mesosphere.types.gen.compiler.internal.arguments.ValueArguments;
...
import io.mesosphere.types.gen.models.internal.values.DateTimeValue;
...
public class StringTemplateEngine implements CompilerEngine {
    ...
    public StringTemplateEngine(RepositoryView compilerView) throws IOException {
        ...
        this.group.defineTemplate("concat", "parts", "<parts>");
