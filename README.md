...
Support for DC/OS ends on October 31, 2021. We will continue to provide support for our current DC/OS customers per their contracts, of course. However, we will no longer be investing in new features or capabilities or maintaining the related repositories. Continued use of the DC/OS open source platform, Marathon, and other DC/OS components will be at your own discretion and risk.
